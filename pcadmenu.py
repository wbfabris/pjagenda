...
def pxtelacria():
    ...
    # --- Cria o Frame_Layout ---
    layout_frame = [[sg.Text('Selecione uma Opção')],
        [sg.Radio('Consultar',  'RADIO1', size=(10, 1), key='CON', default=False,
            enable_events=True)],
        [sg.Radio('Cadastrar',  'RADIO1', size=(10, 1), key='INC',  default=False,
            enable_events=True)],
        [sg.Radio('Alterar  ',  'RADIO1', size=(10, 1), key='ALT', default=False,
            enable_events=True)],
        [sg.Radio('Finalizar',  'RADIO1', size=(10, 1), key='FIM', default=False,
            enable_events=True)]]
...
def pxtelaprocessa(layout):
    ...
    # --- Cria a Tela ----
    window = sg.Window("Menu de Opções", layout) #, finalize=True)
    #
