...
class Dtoprm:
    ...
    def __init__(self, patharq = [], pathdb = [],
        layout = '', window = '', event = [], values = [],
        data = [], datafrmt = [], datasel = [], row = 0,
        local = [],  conv = [], vemcons = False,
        dctab = {'-prof-': 'INC', '-ende-': 'INC', '-agen-': 'INC', '-cont-': 'INC'},
        dcloc = {'local': 0},
        dccnv = {'conve': 0},
        dcuscnv = {},
        dcusloc = {},
        dcids = {'id_med': 0, 'id_local': 0,  'id_end': 0, 'id_age': 0, 'id_cont': 0, 'id_conv': 0},
        idpsq = '',  wctralt = True, opcmenu = '',
        inmed = '-INMED-', psq = '-PSQ-', lst = '-LIST-', campo = ''):
        ...
        self.datafrmt = datafrmt    # reg. formatados para a consluta dos selecionados
