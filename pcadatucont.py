...
def pxcontinc(odtoprm):
    ...
    if odtoprm.dcids['id_med'] == 0:
        ...
        #--- Inclui Contato ---                
        wtab = 'TCADMEDCONT0'
        wsql =  '{} {}({}, {}, \n'.format('INSERT INTO', 'TCADMEDCONT0', 'id_med', 'id_conv')
        wsql += '{}, {}, {}, \n'.format('de_email1', 'de_email2', 'nu_cel1')
        wsql += '{}, {}, {}) \n'.format('nu_cel2', 'nu_cel3', 'de_obs')
        wsql += '{} \n'.format('VALUES ')
        wsql += '("{}", "{}", \n'.format(odtoprm.dcids['id_med'], odtoprm.dcids['id_conv'])
        wsql += '"{}", "{}", "{}", \n'.format(odtoprm.values['emai1'],  odtoprm.values['emai2'], odtoprm.values['cel1'])
        wsql += '"{}", "{}", "{}")'.format(odtoprm.values['cel2'],  odtoprm.values['cel3'],  odtoprm.values['obs'])
