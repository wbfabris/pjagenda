...
def pxtelacria(odtoprm):
    ...
    #--- Nome ---
    layout_1 = [[sg.Text('Nome.......:', size=(10, 0)),
    ...
    #--- Endereço ---
    layout_2 = [[sg.Input(size=(65, 0), background_color='white', text_color='blue',
          disabled=True, key='ussel', justification='center'),
          sg.Input(size=(5, 0), background_color='white', text_color='blue',
          disabled=True, key='opend',justification='center')],
        [sg.Text('Local......:', size=(10, 0)), sg.Combo(odtoprm.local,
          size=(10, 0), key='-local-')],
        [sg.Text('CEP........:', size=(10, 0)), sg.Input(size=(15, 0),
          key='cep', default_text=''), sg.Button('Pesq. Cep')],
        [sg.Text('Endereço...:', size=(10, 0)), sg.Input(size=(50, 0),
          key='ende', default_text='')],
        [sg.Text('Número.....:', size=(10, 0)), sg.Input(size=(6, 0),
          key='nume', default_text=''), sg.Text('Complemento:',
         size=(10, 0),), sg.Input(size=(6, 0), key='comp', default_text='')],
        [sg.Text('Cidade.....:', size=(10, 0)), sg.Input(size=(50, 0),
          key='cida', default_text='')],
        [sg.Text('Bairro.....:', size=(10, 0)), sg.Input(size=(50, 0),
          key='bair', default_text='')],
        [sg.Text('Estado.....:', size=(10, 0)), sg.Input(size=(3, 0),
          key='esta', default_text='')],
        [sg.Text('Telefone 1.:', size=(10, 0)), sg.Input(size=(50, 0),
          key='tel1', default_text='')],
        [sg.Text('Telefone 2.:', size=(10, 0)), sg.Input(size=(50, 0),
          key='tel2', default_text='')],
        [sg.Text('Telefone 3.:', size=(10, 0)), sg.Input(size=(50, 0),
          key='tel3', default_text='')],
        [sg.Text('Obs.......:', size=(10, 0)), sg.Input(size=(80, 0),
          key='obse', default_text='')],
        [sg.Button('Salvar', key='salvar'), sg.Button('Excluir', key='endeexc',
          disabled=True),sg.Button('Limpar', key='limpar'),
          sg.Button('Voltar', key='endvoltar')]]

    #--- Agenda ---
    layout_3 = [[sg.Input(size=(35, 0), background_color='white', text_color='blue',
          disabled=True, key='ussel1', justification='center'),
          sg.Input(size=(5, 0), background_color='white', text_color='blue', disabled=True,
          key='opage', justification='center')],
        [sg.Frame('',
        [[sg.Text('Dia Semana', size=(10, 0)), sg.Text('     Manhã', size=(7, 0)),
          sg.Text('Tarde', size=(7, 0))],
        [sg.CBox('Segunda', size=(10, 1), key='cb0'), sg.CBox('M', key='cb1',
          default=False), sg.CBox('T', key='cb2')],
        [sg.CBox('Terça  ', size=(10, 1), key='cb3'), sg.CBox('M', key='cb4',
          default=False), sg.CBox('T', key='cb5')],
        [sg.CBox('Quarta ', size=(10, 1), key='cb6'), sg.CBox('M', key='cb7',
          default=False), sg.CBox('T', key='cb8')],
        [sg.CBox('Quinta ', size=(10, 1), key='cb9'), sg.CBox('M', key='cb10',
          default=False), sg.CBox('T', key='cb11')],
        [sg.CBox('Sexta  ', size=(10, 1), key='cb12'), sg.CBox('M',
          key='cb13',default=False), sg.CBox('T', key='cb14')],
          [sg.Button('Salvar', key='salvar'),
          sg.Button('Excluir', key='agenexc', disabled=True),
          sg.Button('Limpar', key='limpar'),
          sg.Button('Voltar', key='agevoltar')]])]]

    #--- Contato ---
    layout_4 = [[sg.Input(size=(54, 0), background_color='white', text_color='blue',
          disabled=True, key='ussel2', justification='center'),
          sg.Input(size=(5, 0), background_color='white', text_color='blue', disabled=False,
          key='opcon', justification='center')],
        [sg.Text('Email1....:', size=(10, 0)), sg.Input(size=(40, 0), key='emai1')],
        [sg.Text('Email2....:', size=(10, 0)), sg.Input(size=(40, 0), key='emai2')],
        [sg.Text('Convenio......:',), sg.Combo( odtoprm.conv, key='-conv-')],
        [sg.Text('Celular1..:', size=(10, 0)), sg.Input(size=(20, 0),
          key='cel1', default_text='')],
        [sg.Text('Celular2..:', size=(10, 0)), sg.Input(size=(20, 0),
          key='cel2', default_text='')],
        [sg.Text('Celular3..:', size=(10, 0)), sg.Input(size=(20, 0),
          key='cel3', default_text='')],
        [sg.Text('Obs.......:', size=(10, 0)), sg.Input(size=(80, 0),
          key='obs', default_text='')],
        [sg.Button('Salvar', key='salvar'),
          sg.Button('Excluir', key='contexc', disabled=True),
          sg.Button('Limpar', key='limpar'),
          sg.Button('Voltar', key='convoltar')]]

    tab_group = sg.TabGroup([[sg.Tab("Profissional", layout_1, key='-prof-'),
...
def pxtelaprocessa(odtoprm):
    ...
    # --- Cria a Tela ---
    window = sg.Window('Agenda de Profissionais', odtoprm.layout) #, finalize=True)
    ...
    while wsctrl:
        ...
        if odtoprm.vemcons:
            ...
            elif event in ('profvoltar', 'endvoltar', 'agevoltar', 'convoltar'):
                wsctrl = False
...
def pxpesqcep(odtoprm):
    ...
    if len(odtoprm.values['cep']) == 0:
        ...
        if lsend['logradouro'] == 'CEP invalido':
            sg.popup('CEP', 'Cep invalido')

        elif lsend['logradouro'] == 'CEP Não Cadastrado':
            sg.popup('CEP', 'CEP Não Cadastrado')
        else:
            odtoprm.window['ende'].update(lsend['logradouro'])
            odtoprm.window['cida'].update(lsend['cidade'])
